...
import rhr from "@/assets/img.jpg";
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        ...
        >
          <p className="text-lg md:text-xl font-light max-w-2xl mx-auto leading-relaxed text-white/85 drop-shadow-lg">
            Experience luxury redefined in our boutique hotel, where Cycladic
            elegance meets modern comfort just steps away from the heart of
            Paros.
          </p>
        </div>
        ...
        <div
          ref={chevronRef}
          className="opacity-0 absolute bottom-8 inset-x-0 z-10 flex justify-center"
